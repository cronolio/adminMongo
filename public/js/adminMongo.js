...
function paginate(){
    ...
    .done(function(response){
        ...
        for(var i = 0; i < response.data.length; i++){
            ...
            var inner_html = '<div class="col-xs-12 col-md-10 col-lg-12 no-side-pad"><pre class="code-block ' + docClass + '"><i class="fa fa-chevron-down code-block_expand"></i><code class="json">' + escaper[0].innerHTML + '</code></pre></div>';
